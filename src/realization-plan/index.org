...
* Milestones Snapshot
  ...
  |   | no | no | Map |                                    |      |        | hrs | hrs |        |
  |---+----+----+-----+------------------------------------+------+--------+-----+-----+--------|
  |   | 1. | [[https://github.com/virtual-labs/vlabs-about/milestone/1][1]]  |     | [[https://github.com/virtual-labs/vlabs-about/milestone/1][Literate mode of vlabs about pages]] | [[Literate mode of vlabs about pages][ref]]  | Close  | 18  | 0   | [[https://github.com/vlead/vlabs-landing-pages/milestone/9][ref]]    |
  |---+----+----+-----+------------------------------------+------+--------+-----+-----+--------|
  | ^ |    |    |     |                                    |      |        | est | act |        |
  |---+----+----+-----+------------------------------------+------+--------+-----+-----+--------|
